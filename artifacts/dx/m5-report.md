...
Generated: 2026-08-26T23:23:38.283Z by `bun run test:dx-cleanroom`.
...
| --- | ---: | --- |
| pack @bundar/core | 14 | ok |
| pack @bundar/jsx | 7 | ok |
| pack @bundar/schema | 7 | ok |
| pack @bundar/forms | 8 | ok |
| pack @bundar/security | 12 | ok |
| pack @bundar/htmx | 12 | ok |
| pack @bundar/testing | 10 | ok |
| pack @bundar/cli | 9 | ok |
| pack create-bundar | 10 | ok |
| registry | 193 | 9 packed tarballs with file: rewrites |
| generate | 10 | create-bundar app with packed-tarball deps |
| install | 698 | ok |
| typecheck | 1351 | ok |
| test | 45 | ok |
| build | 30 | ok |
| routes:generate | 82 | ok |
| routes:check | 75 | ok |
| live-http | 14 | health, form PRG, fragment, 422 with clear message |
| routes:check (drifted) | 72 | FAILED exit 1: $ bun ./node_modules/@bundar/cli/src/bin.ts routes check --entry src/app.ts --out src/routes.gen.ts

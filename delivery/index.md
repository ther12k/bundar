...
- [GitHub Issue Map](baseline/github-issue-map.md) — Stable BR-NNN → issue-number mapping after the bulk creation runbook; BR-001…BR-046 closed on main, BR-047…BR-085 open.

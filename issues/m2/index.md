...
- [GH-032 — Implement document, doctype, head, and void-element helpers](gh-032-implement-document-doctype-head-and-void-element-helpers.md) — P1 / M; depends on GH-028, GH-029 — **complete 2026-08-22** (closure record and evidence)
- [GH-033 — Implement renderToString and JSX Response integration](gh-033-implement-rendertostring-and-jsx-response-integration.md) — P0 / M; depends on GH-021, GH-030, GH-032 — **complete 2026-08-22** (closure record and evidence)

...
- [ ] All mandatory M0–M6 gates pass from the release commit.
- [ ] Package names are cleared/reserved.
- [ ] Stable lane and no-JS matrix pass.
- [ ] Release artifact hashes match provenance and installed packages.
- [ ] HTMX 4 remains experimental and non-default.
